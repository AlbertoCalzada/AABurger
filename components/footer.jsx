    ...
    return (
        ...
        <footer className="text-gray-600 body-font bg-gradient-to-r from-yellow-400 via-orange-500 to-red-500 bg-opacity-90">
            <div className="container px-5 py-8 mx-auto flex items-center justify-center sm:flex-row flex-col">
                ...
                <p className="mr-5 font-bold text-gray-700 hover:text-gray-900 transition-colors duration-200">
                    © {currentYear} - Todos los derechos reservados
                </p>
                <div className="mr-5 font-bold text-gray-700 hover:text-gray-900 transition-colors duration-200 flex flex-col sm:flex-row mt-4">
